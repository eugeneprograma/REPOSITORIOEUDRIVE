function prefer(){
    ...
    let res=true;
        ...
        numUser= prompt("Ingrese su numero de usuario");
        if (nomuser!==null){
            var n=num.toString().padStart(2,'0');
            //toString: poner numero a texto
            //padStart: para rellenar dos digitos digitos a la izquierda. En este caso coloca DOS digitos, se pueden colocar mas.
